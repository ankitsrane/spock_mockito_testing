package com.example.spring.tutorials.testing.mockito.fluentapi;
...
import com.example.spring.tutorials.testing.mockito.fluentapi.Pizza.PizzaBuilder;
...
public class PizzaServiceUnitTest {
    ...
    public void givenTraditonalMocking_whenServiceInvoked_thenPizzaIsBuilt() {
        ...
        nameBuilder = Mockito.mock(PizzaBuilder.class);
        PizzaBuilder sizeBuilder = Mockito.mock(PizzaBuilder.class);
        PizzaBuilder firstToppingBuilder = Mockito.mock(PizzaBuilder.class);
        PizzaBuilder secondToppingBuilder = Mockito.mock(PizzaBuilder.class);
        PizzaBuilder stuffedBuilder = Mockito.mock(PizzaBuilder.class);
        PizzaBuilder willCollectBuilder = Mockito.mock(PizzaBuilder.class);
        PizzaBuilder discountBuilder = Mockito.mock(PizzaBuilder.class);

        PizzaBuilder builder = Mockito.mock(PizzaBuilder.class);
        ...
        assertEquals("Pizza size: ", Pizza.PizzaSize.LARGE, sizeCaptor.getValue());
